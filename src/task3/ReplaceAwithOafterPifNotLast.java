...
public class ReplaceAwithOafterPifNotLast {
    public static void main(String[] args) {
        final String s = "\"\"Hokus Pakus\"\n" +
                "\n" +
                ...
                "It's hokus Pakus jokers, Great Milenko.\n" +
                "\n" +
                "[Chorus (1x)]\n" +
                "Once again, the psychotic carnival creatures in the haugh\n" +
                "Hokus Pakus, joker's ride, come take a spin on a carnie ride\n" +
                ...
                "I bounce down Verner in a Papcorn clown truck \n" +
                ...
                "Hokus Pakus Jokers, Great Milenko. \n" +
                "\n" +
                "[Chorus (1x)]\n" +
        ...
        for (String sss : ss) {
            Pattern p = Pattern.compile("(.*[P]{1})a(.*)");
            Matcher m = p.matcher(sss);
            if (m.matches()) {
                result.append(m.group(1)).append("o").append(m.group(2));
            } else {
                result.append(sss);
            }
            result.append("\n");
